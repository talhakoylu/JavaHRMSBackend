...
public class IMDExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(IMDDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new IMDStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static IMDDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static IMDDateTimeConverter dateTimeConverter = new IMDStandardDateTimeConverter();

    public IMDExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public IMDExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new IMDMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=IMDHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,IMDExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=IMDHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
