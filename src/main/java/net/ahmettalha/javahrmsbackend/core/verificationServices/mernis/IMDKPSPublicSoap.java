...
public class IMDKPSPublicSoap
{
    ...
    public IMDKPSPublicSoap(){}

    public IMDKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public IMDKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        IMDExtendedSoapSerializationEnvelope envelope= new IMDExtendedSoapSerializationEnvelope(IMDExtendedSoapSerializationEnvelope.VER11);
