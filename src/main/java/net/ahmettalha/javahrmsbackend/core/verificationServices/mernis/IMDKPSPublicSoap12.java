package net.ahmettalha.javahrmsbackend.core.verificationServices.mernis;
...
public class IMDKPSPublicSoap12
{
    interface IMDIWcfMethod
    {
        IMDExtendedSoapSerializationEnvelope CreateSoapEnvelope() throws java.lang.Exception;

        java.lang.Object ProcessResult(IMDExtendedSoapSerializationEnvelope __envelope,java.lang.Object result) throws java.lang.Exception;
    }
    ...
    public IMDKPSPublicSoap12(){}

    public IMDKPSPublicSoap12(String url)
    {
        this.url = url;
    }

    public IMDKPSPublicSoap12(String url,int timeOut)
    {
        this.url = url;
    ...
    protected IMDExtendedSoapSerializationEnvelope createEnvelope()
    {
        IMDExtendedSoapSerializationEnvelope envelope= new IMDExtendedSoapSerializationEnvelope(IMDExtendedSoapSerializationEnvelope.VER12);
        envelope.enableLogging = enableLogging;
    
        return envelope;
    }

    protected java.util.List sendRequest(String methodName,IMDExtendedSoapSerializationEnvelope envelope,org.ksoap2.transport.Transport transport ,com.easywsdl.exksoap2.ws_specifications.profile.WS_Profile profile )throws java.lang.Exception
    {
    ...
    java.lang.Object getResult(java.lang.Class destObj,java.lang.Object source,String resultName,IMDExtendedSoapSerializationEnvelope __envelope) throws java.lang.Exception
    {
        if(source==null)
        {
            return null;
    ...
    public Boolean TCKimlikNoDogrula(final Long TCKimlikNo,final String Ad,final String Soyad,final Integer DogumYili) throws java.lang.Exception
    {
        ...
        return (Boolean)execute(new IMDIWcfMethod()
        {
            @Override
            public IMDExtendedSoapSerializationEnvelope CreateSoapEnvelope(){
                IMDExtendedSoapSerializationEnvelope __envelope = createEnvelope();
            ...
            @Override
            public java.lang.Object ProcessResult(IMDExtendedSoapSerializationEnvelope __envelope,java.lang.Object __result)throws java.lang.Exception {
    ...
    protected java.lang.Object execute(IMDIWcfMethod wcfMethod,String methodName,com.easywsdl.exksoap2.ws_specifications.profile.WS_Profile profile) throws java.lang.Exception
    {
        org.ksoap2.transport.Transport __httpTransport=createTransport();
        __httpTransport.debug=enableLogging;
        IMDExtendedSoapSerializationEnvelope __envelope=wcfMethod.CreateSoapEnvelope();
        try
        {
    ...
    protected java.lang.Exception convertToException(org.ksoap2.SoapFault fault,IMDExtendedSoapSerializationEnvelope envelope)
    {
